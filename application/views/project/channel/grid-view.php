                        ...
                        <div class="actions">
                            <div class="btn-group">
                                ...
                                <?php if ($role_id == 2) {
                                    ...
                                    <button class="btn btn-info btn-xs" onclick="location.href = '<?php echo base_url('project_new/edit_channel_new/?id=' . $dc_g->id); ?>'">
                                        <i class="fa fa-pencil"></i>
                                    </button>
                                <?php }
                                ?>    
                                ...
                                <div class="caption">
                                    ...
                                    <p style="text-align:center;">
                                        ...
                                        if ($role_id == 1 || $role_id == 2) {
                                            $onclick_inactive = base_url('main_function/set_status/?id=' . $dc_g->id . '&tbl_name=tbl_channel&status=0&param1=' . $project_id);
                                            $onclick_active = base_url('main_function/set_status/?id=' . $dc_g->id . '&tbl_name=tbl_channel&status=1&param1=' . $project_id);
                                        } else {
                                            $onclick_inactive = "";
                                            $onclick_active = "";
                                        }
