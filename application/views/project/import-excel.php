    ...
    <div class="col-md-8">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                ...
                <button onclick="location.href = '<?php echo base_url('assets/excel/templates.xlsx'); ?>'" class="btn btn-md btn-info"><span class="fa fa-download"></span> Template</button>
                <form method="post" action="<?php echo base_url('project_new/import_action'); ?>" enctype="multipart/form-data" role="form" class="form-horizontal">
                    <div class="form-body">
