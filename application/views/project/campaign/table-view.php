                        ...
                        <tr>
                            ...
                            if ($this->MainModels->UserSession('role_id') == 2) {
                                ...
                                <td style="text-align:center;">
                                    <a class="badge badge-primary" href="<?php echo base_url('lead/?campaign_id=' . $dc->id); ?>"><?php echo count($this->LeadModels->getDataLeadbyCampaignId($dc->id)); ?></a>
                                </td>
                                <?php
                            } else {
                                ?>
                                <td style="text-align:center;"><a class="badge badge-primary"><?php echo count($this->LeadModels->getDataLeadbyCampaignId($dc->id)); ?></a></td>
                                <?php
                            }
                            ?>
