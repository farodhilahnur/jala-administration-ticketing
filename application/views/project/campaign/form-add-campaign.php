        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="portlet-body form">
                    <form enctype="multipart/form-data" class="form-horizontal" action="<?php echo base_url('project_new/add_campaign'); ?>" role="form" method="post">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <textarea class="form-control" cols="5" rows="3" name="campaign_detail"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
