...
<body style="background: #F5F5F5 !important;" class="page-container-bg-solid page-header-fixed page-md">
<!-- BEGIN HEADER -->
<?php $this->load->view('template/header__'); ?>
...
<script>
    $(document).ready(function () {
        function resize(x) {
            if (x.matches) {
                $(".hide-topbar")[0].setAttribute('style', 'display:none !important');
                $(".page-sidebar-wrapper")[0].setAttribute('style', 'display:block !important');
                $(".page-top")[0].setAttribute('style', 'display:none !important');
            } else {
                $(".hide-topbar")[0].setAttribute('style', 'display:block !important');
                $(".page-sidebar-wrapper")[0].setAttribute('style', 'display:none !important');
                $(".page-top")[0].setAttribute('style', 'display:block !important');
            }
        }
...
if (!empty($view_folder)) {
    $this->load->view($view_folder . '/amchartConf');
}
?>
