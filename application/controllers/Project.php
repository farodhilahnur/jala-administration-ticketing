...
//        $modals_assets = $this->MainModels->getAssets('modals');
        ...
        $css = array_merge($datatable_assets['css'], $daterangepicker_assets['css'], $file_input_assets['css'], $select2_assets['css']);
    ...
    public function channel()
    {
        ...
        $css = array_merge($datatable_assets['css'], $select2_assets['css'], $daterangepicker_assets['css'], $file_input_assets['css'], $input_mask['css']);
    ...
    public function form_add_channel()
    {
        ...
        $data_offline = $this->db->get_where('tbl_media', array('media_category' => 3))->result();
        ...
        if ($post) {
            ...
            redirect(base_url('project/form_add_channel/?id=' . $project_id . '&step=' . $next_step));
        ...
        $this->template->load('template', 'project/form_add_channel', $data);
    }
