...
<div class="portlet light bordered">
                ...
                <div class="form-group">
                    <div class="row">
                        <form action="" method="get">
                            <div class="col-md-6">
                                <select id="selectStatus1" name="category_id_1" style="margin-left: 70px;" class="form-control">
                                    <option>--Select Category--</option>
                                    <option value="0"     
                                    <?php
                                    if ($session_dashboard['category_id_1'] == 0) {
                                        echo "selected";
                                    }
                                    ?>
                                            >All
                            ...
                            <div class="col-md-1">
                                <button type="submit" name="versus" value="1" class="btn btn-md btn-default"><span class="fa fa-search"></span></button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <div class="portlet-body">
        <div id="chartLeadTotal" style="height:300px;"></div>
    </div>
</div>
<!-- END Portlet PORTLET-->