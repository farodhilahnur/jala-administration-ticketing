            ...
            <div class="col-md-12">
                ...
                <div class="col-lg-2 col-md-2 col-sm-4 col-xs-6">
                    <div class="dashboard-stat yellow">
                        ...
                        <div class="details">
                            <div class="number">
                                <?php if($this->MainModels->UserSession('role_id') != 3){
                                    ?><span data-counter="counterup" data-value="<?php echo count($data_lead); ?>"></span></div><?php
                                } else {
                                    ?><span data-counter="counterup" data-value="<?php echo $data_lead; ?>"></span></div><?php
                                } 
                                ?>
