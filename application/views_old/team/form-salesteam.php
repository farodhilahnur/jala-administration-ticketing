    ...
    <div class="col-md-12">
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-user-plus"></i> Sales Team Form </div>
            </div>
                ...
                <form action="" method="post" class="form-horizontal">
                    <div class="form-body">
                        <div class="row">
                            ...
                            if ($function == 'edit') {
                                ?>
                                <input name="sales_team_id" type="hidden" value="<?php echo $data_sales_team->sales_team_id; ?>">
                            ...
                            <div  class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label col-md-3">Coverage Area</label>
                                    <div style="display:block;" id="form-coverage-area" class="col-md-6">
                                        <select name="coverageArea[]" id="multiple" class="form-control select2-multiple multiple-kota" multiple>
                                            <?php
                                            foreach ($data_kota as $value) {
                                                ?>      
                                                <option value="<?php echo $value->kota_id; ?>"
                                                <?php
                                                if ($function == 'edit') {
                                                    if (in_array($value->kota_id, $coverage_area)) {
                                                        echo "selected";
                                                    }
                                                }
                                                ?>
                                                        >
                                                            <?php echo $value->kota_name; ?>
                                                </option>
                                                <?php
                                            }
                                            ?>
                                    ...
                                    <div class="col-md-3">
                                        <input name="allCity" id="all-city" class="form-control" type="checkbox" id="checkbox" <?php
                                        if ($function == 'edit') {
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input name="salesTeamName" 
                                               type="text" 
                                               class="form-control"
                                               value="<?php
                                               if ($function == 'edit') {
                                                   echo $data_sales_team->sales_team_name;
                                               }
                                               ?>"
                                               required
                                               > 
                                            ...
                                            <select name="client_id" class="form-control">
                                                ...
                                                if ($data_client) {
                                                    foreach ($data_client as $dc) {
                                                        ...
                                                        <?php
                                                        if ($function == 'edit') {
                                                            if ($dc->client_id == $data_sales_team->client_id) {
                                                                echo "selected";
                                                            }
                                                        }
                                                        ?>        
