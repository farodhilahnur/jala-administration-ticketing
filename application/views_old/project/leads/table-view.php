        ...
        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
            <thead>
                <tr>
                    ...
                    <th style="display: none;" id="leadAddressHeader"> Address </th>
                ...
                if (!empty($data_lead)) {
                    ...
                    foreach ($data_lead as $key => $dl) {
                        ...
                        <tr>    
                            ...
                            <td style="display: none;" id="leadAddressField-<?php echo $key; ?>"><?php echo $dl->lead_address . "<br><b><i>" . $dl->kota_name . "</b></i>"; ?></td>
