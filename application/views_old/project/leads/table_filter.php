        ...
        <div class="col-md-6">
            ...
            <div class="btn-group">
                ...
                <div class="dropdown-menu hold-on-click dropdown-checkboxes" role="menu">
                    ...
                    <label>
                        <input id="leadAddressFilter" data-id="0" type="checkbox" data-source="<?php echo $total; ?>">Address</label>
                    <label>
                    ...
                    <label>
                        <input id="leadProductFilter" type="checkbox" data-id="0" data-source="<?php echo $total; ?>" >Product</label>
                    <label>
                    ...
                    <label>
                        <input id="leadNoteFilter" type="checkbox" data-id="0" data-source="<?php echo $total; ?>" >Note</label>
                    <!--<div class="">
