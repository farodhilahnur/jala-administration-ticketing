<div class="row">
    ...
    if (!empty($data_campaign_filter)) {
        foreach ($data_campaign_filter as $dc_g) {
            ?>
            <div class="col-md-4 ">
                                ...
                                <div class="caption">
                                    ...
                                    <p>
                                        ...
                                        if ($role_id == 1 || $role_id == 2) {
                                            $onclick_inactive = base_url('main_function/set_status/?id=' . $dc_g->id . '&tbl_name=tbl_campaign&status=0&param1=' . $project_id);
                                            $onclick_active = base_url('main_function/set_status/?id=' . $dc_g->id . '&tbl_name=tbl_campaign&status=1&param1=' . $project_id);
                                        } else {
                                            $onclick_inactive = "";
                                            $onclick_active = "";
                                        }
