                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                if ($role_id == 1 || $role_id == 2) {
                                    $onclick_inactive = base_url('main_function/set_status/?id=' . $dc->id . '&tbl_name=tbl_channel&status=0');
                                    $onclick_active = base_url('main_function/set_status/?id=' . $dc->id . '&tbl_name=tbl_channel&status=1');
                                } else {
                                    $onclick_inactive = "";
                                    $onclick_active = "";
                                }
