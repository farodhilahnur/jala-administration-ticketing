...
class Project extends CI_Controller {
    ...
    public function leads() {
        ...
        $js = array_merge($datatable_assets['js'], $daterangepicker_assets['js'], $modals_assets['js'], $select2_assets['js'], $counterup_assets['js'], $amcharts_assets['js'], $lead_assets['js']);
        $css = array_merge($datatable_assets['css'], $daterangepicker_assets['css'], $modals_assets['css'], $select2_assets['css'], $counterup_assets['css'], $amcharts_assets['css']);
...
//                    }
                    ...
                    array_push($data, array(
                        ...
                        'lead_gender' => $gender, // Ambil data alamat
                        'channel_id' => $channel_id,
                        'status_id' => $status_id,
                    ));
                }
        ...
        if ($upload['result'] == 'success') { // Jika proses upload sukses
            ...
            foreach ($sheet as $row) {
                ...
                if ($numrow > 1) {
                    ...
                    array_push($data, array(
                        'create_date' => $row['G'],
                        'lead_name' => $row['C'], // Ambil data nama
